  ...
  <!--MENU de notificação-->
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="../login/MeusProdutos.php">Meus Produtos</a>
              </li>
      ...
      <!--<div class="card" style="width: 18rem;">
        <div class="card-body">
          ...
          <h6 class="card-subtitle mb-2 text-muted">Conheça nossa história</h6>
          <p class="card-text">2 meninas 1 sonho, criar um site de registrar preços uauu </p>
